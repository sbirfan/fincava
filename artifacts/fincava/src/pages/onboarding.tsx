...
const COLOMBIA_DEPARTMENTS = [
  ...
  "Arauca","Putumayo","Amazonas","Guainía","Guaviare","Vaupés","Vichada"
];

const PRODUCT_OPTIONS = [
  { value: "cacao", labelEn: "Specialty Cacao", labelEs: "Cacao Especial" },
  { value: "cafe", labelEn: "Coffee (Café)", labelEs: "Café" },
  { value: "bocadillo", labelEn: "Bocadillo de Guayaba", labelEs: "Bocadillo de Guayaba" },
  { value: "panela", labelEn: "Panela / Organic Cane Sugar", labelEs: "Panela / Azúcar de Caña Orgánica" },
  { value: "lulo", labelEn: "Lulo (Naranjilla)", labelEs: "Lulo" },
  { value: "feijoa", labelEn: "Feijoa", labelEs: "Feijoa" },
  { value: "pitahaya", labelEn: "Pitahaya (Dragon Fruit)", labelEs: "Pitahaya" },
...
const INITIAL: FormData = {
  ...
  farm_size_hectares: "", annual_volume_kg: "",
  harvest_months: "", organic_certified: "",
        ...
        <div className="flex items-center justify-center mb-8 gap-1">
          {steps.map((s, i) => (
            <div key={s.num} className="flex items-center">
              ...
              {i < steps.length - 1 && (
                <div className={`w-8 h-0.5 mb-4 mx-1 ${step > s.num ? "bg-green-400" : "bg-gray-200"}`} />
              )}
            </div>
          ))}
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-md p-6">
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <input className={inputClass} value={form.farm_name}
              ...
              <div>
                ...
                <input className={inputClass} value={form.owner_name}
              ...
              <div>
                ...
                <select className={selectClass} value={form.department}
                  onChange={e => set("department", e.target.value)}>
                  <option value="">{lang === "es" ? "Seleccionar departamento" : "Select department"}</option>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input className={inputClass} value={form.municipio}
                ...
                <div>
                  ...
                  <input className={inputClass} value={form.vereda}
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <select className={selectClass} value={form.primary_product}
                  onChange={e => set("primary_product", e.target.value)}>
                  <option value="">{lang === "es" ? "Seleccionar producto" : "Select product"}</option>
              ...
              {form.primary_product === "other" && (
                <div>
                  ...
                  <input className={inputClass} value={form.other_product}
              ...
              <div>
                ...
                <input className={inputClass} value={form.harvest_months}
                  onChange={e => set("harvest_months", e.target.value)}
                  placeholder={lang === "es" ? "Ej. Marzo, Abril, Octubre" : "e.g. March, April, October"} />
              </div>
              <div>
                <label className={labelClass}>
          ...
          {step === 3 && (
            <div className="space-y-4">
              ...
              <div>
                <label className={labelClass}>
                  {lang === "es" ? "Capital de trabajo necesario (USD)" : "Working capital needed (USD)"}
                </label>
                <input className={inputClass} type="number" min="0"
          ...
          {step === 4 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <input className={inputClass} value={form.officer_name}
              ...
              <div>
                ...
                <input className={inputClass} value={form.officer_code}
            ...
            {step < 4 ? (
              <button
                onClick={() => {
                  ...
                  if (step === 1 && (!form.farm_name || !form.owner_name || !form.phone || !form.department || !form.municipio)) {
                    alert(lang === "es" ? "Por favor complete los campos requeridos (*)" : "Please fill required fields (*)");
                    return;
                  }
                  if (step === 2 && !form.primary_product) {
                    alert(lang === "es" ? "Por favor seleccione el producto principal" : "Please select primary product");
                    return;
                  }
              ...
              >
                {submitting
                  ...
                  : (lang === "es" ? "Registrar Proveedor ✓" : "Register Supplier ✓")}
              </button>
            )}
          </div>
        </div>
