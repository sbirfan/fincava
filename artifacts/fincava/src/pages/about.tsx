      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Fincava is building the trust infrastructure for agricultural trade in emerging markets,
            starting with Colombian coffee and cacao, with expansion across additional crops underway.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
          <div className="rounded-xl overflow-hidden shadow-lg h-96">
            <img src="/images/cacao.png" alt="Colombian cacao" className="w-full h-full object-cover" />
          </div>
          <div>
        ...
        <div className="max-w-3xl mx-auto mb-24">
          <h2 className="text-3xl font-serif font-bold mb-6 text-center">What we do</h2>
        ...
        <div className="bg-card border rounded-2xl p-8 md:p-12 mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Every change is tracked, creating a complete history of decisions that buyers and
                operators can inspect at any time.
              </p>
            </div>
          </div>
        </div>
