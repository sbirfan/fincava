# CC-1B — Corrected Replit Prompt (v3)
**Fixes applied: N1 (suppliersTable import), N2 (path levels), N3 (console.error), N4 (has_rut state) + all 10 original critical errors.**  
**Date:** 2026-05-04
...
import { suppliersTable } from './suppliers'; // confirmed export name from Step 0
