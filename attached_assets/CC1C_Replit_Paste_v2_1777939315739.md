# CC-1C — Admin Compliance Queue (Corrected v2)
**Prerequisite: CC-1B v3 fully verified — all 7 tables confirmed in Neon, tsc clean.**  
**Date:** 2026-05-04
...
// Adjust relative import depth based on actual file location
```
...
// Weights live in config — adjustable without redeploy.
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-500 mb-4">
        Suppliers ranked by readiness. Formula weights are config-controlled.
        Click any row to open the supplier compliance drawer.
      </p>
...
```
And add a nav link to `/admin/compliance-queue` in the admin navigation component.
