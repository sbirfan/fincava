...
CREATE TABLE "farms" (
	...
	"variedad_cafe" text,
	"hectareas_produccion" numeric(10, 2),
...
CREATE TABLE "onboarding_drafts" (
	...
	"whatsapp_number" text NOT NULL,
	"data" jsonb NOT NULL,
	"restore_token" uuid DEFAULT uuid_generate_v4() NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "onboarding_drafts_whatsapp_number_unique" UNIQUE("whatsapp_number")
);
--> statement-breakpoint
...
CREATE INDEX "suppliers_whatsapp_number_idx" ON "suppliers" USING btree ("whatsapp_number");--> statement-breakpoint
CREATE INDEX "farms_supplier_id_idx" ON "farms" USING btree ("supplier_id");--> statement-breakpoint
CREATE INDEX "economics_supplier_id_idx" ON "economics" USING btree ("supplier_id");--> statement-breakpoint
CREATE INDEX "compliance_docs_supplier_id_idx" ON "compliance_docs" USING btree ("supplier_id");--> statement-breakpoint
CREATE INDEX "ai_outputs_supplier_id_idx" ON "ai_outputs" USING btree ("supplier_id");--> statement-breakpoint
CREATE INDEX "interactions_supplier_id_idx" ON "interactions" USING btree ("supplier_id");--> statement-breakpoint
CREATE INDEX "onboarding_drafts_whatsapp_idx" ON "onboarding_drafts" USING btree ("whatsapp_number");--> statement-breakpoint
CREATE INDEX "onboarding_drafts_updated_at_idx" ON "onboarding_drafts" USING btree ("updated_at");